  ...
  return (
    <div className="relative inline-flex shrink-0" ref={rootRef}>
      ...
      {open ? (
        <div
          className={cx(
            "absolute z-30 mt-1 w-[min(20rem,calc(100vw-2rem))] max-w-[min(20rem,calc(100vw-2rem))] overflow-hidden whitespace-normal break-words rounded-md border border-line bg-panel p-3 text-left font-sans font-normal normal-case shadow-lg",
