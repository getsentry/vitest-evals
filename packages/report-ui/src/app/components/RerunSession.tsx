...
function TaskTray({
  ...
  return (
    <aside
      ...
      className="fixed !right-3 !bottom-3 z-[80] !top-auto !left-auto !m-0 w-[min(28rem,calc(100vw-1.5rem))] overflow-hidden rounded-lg border border-line bg-panel shadow-2xl"
      popover="manual"
