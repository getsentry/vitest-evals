...
export function ReportHeader({
  ...
  return (
    <header className="mb-4 flex items-start justify-between gap-4">
      ...
      <button
        className="inline-flex h-9 shrink-0 items-center gap-2 rounded-md border border-line-subtle bg-panel px-3 text-xs font-semibold text-muted-strong outline-none hover:border-line hover:text-ink focus-visible:ring-2 focus-visible:ring-selected-line"
        type="button"
